...
`scripts/write_exp02_contract_files.sh` is a thin host harness that serializes all one hundred seventeen PeTTa-tested exp02 run-contract records into the v0.1 per-run file convention under `experiments/exp02_small_sweep_20260630/runs/`; it does not drive chemistry logic.
