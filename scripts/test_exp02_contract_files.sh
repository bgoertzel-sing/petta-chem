...
expected_runs=(
  ...
  exp02-seed-103-rules-8-random
  exp02-seed-103-rules-8-shuffled
  exp02-seed-103-rules-8-no-catalysis
  exp02-seed-107-rules-8-random
  exp02-seed-107-rules-8-shuffled
  exp02-seed-107-rules-8-no-catalysis
  exp02-seed-109-rules-8-random
  exp02-seed-109-rules-8-shuffled
  exp02-seed-109-rules-8-no-catalysis
  exp02-seed-113-rules-8-random
  exp02-seed-113-rules-8-shuffled
  exp02-seed-113-rules-8-no-catalysis
  exp02-seed-127-rules-8-random
  exp02-seed-127-rules-8-shuffled
  exp02-seed-127-rules-8-no-catalysis
  exp02-seed-131-rules-8-random
  exp02-seed-131-rules-8-shuffled
  exp02-seed-131-rules-8-no-catalysis
  exp02-seed-137-rules-8-random
  exp02-seed-137-rules-8-shuffled
  exp02-seed-137-rules-8-no-catalysis
  exp02-seed-139-rules-8-random
  exp02-seed-139-rules-8-shuffled
  exp02-seed-139-rules-8-no-catalysis
  exp02-seed-149-rules-8-random
  exp02-seed-149-rules-8-shuffled
  exp02-seed-149-rules-8-no-catalysis
  exp02-seed-151-rules-8-random
  exp02-seed-151-rules-8-shuffled
  exp02-seed-151-rules-8-no-catalysis
  ...
  exp02-seed-167-rules-8-random
  exp02-seed-167-rules-8-shuffled
  exp02-seed-167-rules-8-no-catalysis
  exp02-seed-173-rules-8-random
  exp02-seed-173-rules-8-shuffled
  exp02-seed-173-rules-8-no-catalysis
  exp02-seed-179-rules-8-random
  exp02-seed-179-rules-8-shuffled
  exp02-seed-179-rules-8-no-catalysis
  exp02-seed-181-rules-8-random
  exp02-seed-181-rules-8-shuffled
  exp02-seed-181-rules-8-no-catalysis
  exp02-seed-191-rules-8-random
  exp02-seed-191-rules-8-shuffled
  exp02-seed-191-rules-8-no-catalysis
  exp02-seed-193-rules-8-random
  exp02-seed-193-rules-8-shuffled
  exp02-seed-193-rules-8-no-catalysis
  exp02-seed-197-rules-8-random
  exp02-seed-197-rules-8-shuffled
  exp02-seed-197-rules-8-no-catalysis
...
grep -Fq '(metric generation-seam exp02-seed-103-rules-8-random factored-seed-template)'   "$TMP_DIR/exp02-seed-103-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-103-rules-8-random 0)'   "$TMP_DIR/exp02-seed-103-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZM0 ZM1 ZM01 ZM6) (rule rr1 ZM2 ZM3 ZM23 ZM8)) (ZM01 ZM23) (ZM6 ZM8) rejected)'   "$TMP_DIR/exp02-seed-103-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-107-rules-8-random factored-seed-template)'   "$TMP_DIR/exp02-seed-107-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-107-rules-8-random 0)'   "$TMP_DIR/exp02-seed-107-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZN0 ZN1 ZN01 ZN6) (rule rr1 ZN2 ZN3 ZN23 ZN8)) (ZN01 ZN23) (ZN6 ZN8) rejected)'   "$TMP_DIR/exp02-seed-107-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-109-rules-8-random factored-seed-template)'   "$TMP_DIR/exp02-seed-109-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-109-rules-8-random 0)'   "$TMP_DIR/exp02-seed-109-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZO0 ZO1 ZO01 ZO6) (rule rr1 ZO2 ZO3 ZO23 ZO8)) (ZO01 ZO23) (ZO6 ZO8) rejected)'   "$TMP_DIR/exp02-seed-109-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-113-rules-8-random factored-seed-template)'   "$TMP_DIR/exp02-seed-113-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-113-rules-8-random 0)'   "$TMP_DIR/exp02-seed-113-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZP0 ZP1 ZP01 ZP6) (rule rr1 ZP2 ZP3 ZP23 ZP8)) (ZP01 ZP23) (ZP6 ZP8) rejected)'   "$TMP_DIR/exp02-seed-113-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-127-rules-8-random factored-seed-template)'   "$TMP_DIR/exp02-seed-127-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-127-rules-8-random 0)'   "$TMP_DIR/exp02-seed-127-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZQ0 ZQ1 ZQ01 ZQ6) (rule rr1 ZQ2 ZQ3 ZQ23 ZQ8)) (ZQ01 ZQ23) (ZQ6 ZQ8) rejected)'   "$TMP_DIR/exp02-seed-127-rules-8-random/ACS.metta"

grep -Fq '(metric generation-seam exp02-seed-139-rules-8-random factored-seed-template)'   "$TMP_DIR/exp02-seed-139-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-139-rules-8-random 0)'   "$TMP_DIR/exp02-seed-139-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZT0 ZT1 ZT01 ZT6) (rule rr1 ZT2 ZT3 ZT23 ZT8)) (ZT01 ZT23) (ZT6 ZT8) rejected)'   "$TMP_DIR/exp02-seed-139-rules-8-random/ACS.metta"

grep -Fq '(metric generation-seam exp02-seed-173-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-173-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-173-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-173-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZZ0 ZZ1 ZZ01 ZZ6) (rule rr1 ZZ2 ZZ3 ZZ23 ZZ8)) (ZZ01 ZZ23) (ZZ6 ZZ8) rejected)' \
  "$TMP_DIR/exp02-seed-173-rules-8-random/ACS.metta"

grep -Fq '(metric generation-seam exp02-seed-179-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-179-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-179-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-179-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZZA0 ZZA1 ZZA01 ZZA6) (rule rr1 ZZA2 ZZA3 ZZA23 ZZA8)) (ZZA01 ZZA23) (ZZA6 ZZA8) rejected)' \
  "$TMP_DIR/exp02-seed-179-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-181-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-181-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-181-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-181-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZAB0 ZAB1 ZAB01 ZAB6) (rule rr1 ZAB2 ZAB3 ZAB23 ZAB8)) (ZAB01 ZAB23) (ZAB6 ZAB8) rejected)' \
  "$TMP_DIR/exp02-seed-181-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-191-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-191-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-191-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-191-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZAC0 ZAC1 ZAC01 ZAC6) (rule rr1 ZAC2 ZAC3 ZAC23 ZAC8)) (ZAC01 ZAC23) (ZAC6 ZAC8) rejected)' \
  "$TMP_DIR/exp02-seed-191-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-193-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-193-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-193-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-193-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZAD0 ZAD1 ZAD01 ZAD6) (rule rr1 ZAD2 ZAD3 ZAD23 ZAD8)) (ZAD01 ZAD23) (ZAD6 ZAD8) rejected)' \
  "$TMP_DIR/exp02-seed-193-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-197-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-197-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-197-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-197-rules-8-random/METRICS.metta"
grep -Fq '(acs-candidate pair-0-1 ((rule rr0 ZAE0 ZAE1 ZAE01 ZAE6) (rule rr1 ZAE2 ZAE3 ZAE23 ZAE8)) (ZAE01 ZAE23) (ZAE6 ZAE8) rejected)' \
  "$TMP_DIR/exp02-seed-197-rules-8-random/ACS.metta"


grep -Fq '(metric generation-seam exp02-seed-199-rules-8-random factored-seed-template)' \
  "$TMP_DIR/exp02-seed-199-rules-8-random/METRICS.metta"
grep -Fq '(metric active-acs-count exp02-seed-199-rules-8-random 0)' \
  "$TMP_DIR/exp02-seed-199-rules-8-random/METRICS.metta"
