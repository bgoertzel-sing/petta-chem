...
- `src/chem_exp02.metta` SHA-256: `c88b26c55b3619fdc0919ac9a012ffdc7343fe736613fe0186caf532d8fd436f`
- `experiments/exp02/smoke.metta` SHA-256: `3277a89842e18c88c7219f9a5bab25c72b4c15262e0a56684a55138d14d7b5d2`
- `experiments/exp02_small_sweep_20260630/SUMMARY.md` SHA-256: `4b7c0bca68fd2e5e75b845524dadb797d8df4357519c74fa192c3a3c8d1ad90a`
- `scripts/write_exp02_contract_files.py` SHA-256: `16b2f73f0175edd6f40b3e050afec75cebd486a2d3c43d9f03f52aec266064fe`
- `scripts/test_exp02_contract_files.sh` SHA-256: `31128b2833fd728c5b845b9aba75e34beee80e38678d9420091cede764947407`
...
PeTTa `exp02-fold-sweep-kind-summary`, `exp02-sweep-kind-summary`, and `exp02-sweep-kind-summary-report` atoms now separate planted reciprocal-pair controls from generated-unplanted controls while deriving family-record counts, active-family counts, active-pair totals, and active random-polymer points from tested `run-record` lists. The current folded summaries are unchanged scientifically: planted controls have 4/12 family records with active pairs and 7 total active pairs across four random-polymer points; generated-unplanted controls have 0/15 family records with active pairs and 0 total active pairs across seed-19, seed-23, and factored-template seed-29/seed-31/seed-37. The human-readable report rows are now derived from those folded summary atoms. A concise human-readable table is recorded in `SUMMARY.md`.
