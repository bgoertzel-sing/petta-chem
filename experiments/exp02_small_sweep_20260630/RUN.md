...
- `src/chem_exp02.metta` SHA-256: `f8d7d269cb77fe4611246eb3a4a22cbce89fc4fbef6604eb9530a785fd26cc56`
- `experiments/exp02/smoke.metta` SHA-256: `aa51892e0ff139736b468b5dee6b6957ef0e3d4daa067e2264c154bdff06ce7a`
- `experiments/exp02_small_sweep_20260630/SUMMARY.md` SHA-256: `30cb3bd76df5a5cc3322990d4c9e6a86103213dad9c0b77d0e5bd222708e06a1`
- `scripts/write_exp02_contract_files.py` SHA-256: `2b7ac82d1bc65a8b1f4ad95efd0585d12ccb197b5cf18948be95851bba6cc455`
- `scripts/test_exp02_contract_files.sh` SHA-256: `1e5074ab04ed0acf036b67af09fa96b8d18f89419814670d8d1ac0bf564239d9`
...
PeTTa `exp02-fold-sweep-kind-summary`, `exp02-sweep-kind-summary`, and `exp02-sweep-kind-summary-report` atoms now separate planted reciprocal-pair controls from generated-unplanted controls while deriving family-record counts, active-family counts, active-pair totals, and active random-polymer points from tested `run-record` lists. The current folded summaries are unchanged scientifically: planted controls have 4/12 family records with active pairs and 7 total active pairs across four random-polymer points; generated-unplanted controls have 0/60 family records with active pairs and 0 total active pairs across seed-19, seed-23, and factored-template seed-29/seed-31/seed-37/seed-41/seed-43/seed-47/seed-53/seed-59/seed-61/seed-67/seed-71/seed-73/seed-79/seed-83/seed-89/seed-97/seed-101/seed-103/seed-103. The human-readable report rows are now derived from those folded summary atoms. A concise human-readable table is recorded in `SUMMARY.md`.
